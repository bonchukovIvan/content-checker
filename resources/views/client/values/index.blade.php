...
function display_groups(response) {
    response.forEach((elem) => 
    {
        ...
        if (elem.departaments) {
            elem.departaments.forEach((elem) => {
                const departament_name = create('sites__faculty', elem.name);
                div.appendChild(departament_name);
            });
        }
